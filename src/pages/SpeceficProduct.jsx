              ...
              <div className="p-4 flex flex-col md:flex-row -mx-4">
                ...
                <div className="md:mx-2 md:flex-1">
                  <div className="p-2 rounded outline outline-1 outline-slate-300 bg-white">
                    ...
                    <p className="mb-2 text-gray-600">{`${bike?.bike_meta[0]?.engine_cc} CC bike and ${bike?.bike_meta[0]?.year_of_model} model and it's covered ${formattedPrice(bike?.bike_meta[0]?.kms_run)} KM upto now, gives ${bike?.bike_meta[0]?.mileage} mileage`}</p>

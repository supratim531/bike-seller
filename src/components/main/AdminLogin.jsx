...
function AdminLogin() {
  ...
  return (
    <>
      <div><Toaster /></div>
      <BrowserTitleBar title="Admin Login" />
        ...
        <div className="mx-6 xs:mx-10 sm:mx-32 md:mx-48 xl:mx-60 2xl:mx-[26rem] 3xl:mx-[34rem] lg:flex w-full rounded bg-white">
          ...
          <div className="lg:w-[50%] flex flex-col gap-3 rounded-md">
            ...
            <form onSubmit={adminLogin} className="px-4 py-6 text-lg">
              ...
              {
                isSubmitting ?
                  <button type="button" disabled={true} className="italic uppercase font-[Roboto] py-3 w-full rounded-md flex justify-center items-center font-semibold opacity-50 text-white bg-blue-800">checking...</button> :
                  <button className="uppercase font-[Roboto] py-3 w-full rounded-md flex justify-center items-center hover:scale-105 duration-300 font-medium text-white bg-blue-800">login</button>
              }
            </form>
          </div>
        </div>
